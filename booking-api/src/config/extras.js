...
module.exports = [
  ...
  { id: 'tinte-pestanas', name: 'Tinte', nameEn: 'Tint', durationMinutes: 10, price: 5, applicableServices: ['lifting-pestanas-tradicional', 'lifting-pestanas-coreano'] },
  // Tinte para laminado de cejas: +15 € en servicios.html
  { id: 'tinte-laminado', name: 'Tinte', nameEn: 'Tint', durationMinutes: 15, price: 15, applicableServices: ['laminado-cejas'] },
];
