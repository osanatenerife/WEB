...
module.exports = [
  ...
  { id: 'limpieza-facial-premium', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Limpieza facial premium (Limpieza facial profunda + Hollywood Peel)', nameEn: 'Premium facial cleansing (Deep facial cleansing + Hollywood Peel)', durationMinutes: 120, price: 95, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
