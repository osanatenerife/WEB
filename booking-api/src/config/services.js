...
module.exports = [
  ...
  { id: 'brows-signature', category: 'Hilo & Lifting', categoryEn: 'Threading & Lifting', name: 'Brows Signature (hilo + lifting trad. + laminado + tinte)', nameEn: 'Brows Signature (thread + traditional lifting + lamination + tint)', durationMinutes: 60, price: 75, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  ...
  { id: 'ritual-basic-skin', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Ritual Basic Skin (limpieza + dermaplaning)', nameEn: 'Ritual Basic Skin (cleansing + dermaplaning)', durationMinutes: 90, price: 75, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  { id: 'ritual-relaxing', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Ritual Hidra-Relax (dermaplaning + hidratación + masaje)', nameEn: 'Ritual Hidra-Relax (dermaplaning + hydration + massage)', durationMinutes: 90, price: 80, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  { id: 'ritual-flash-lifting', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Ritual Flash Lifting (limpieza + radiofrecuencia + maderoterapia)', nameEn: 'Ritual Flash Lifting (cleansing + radiofrequency + wood therapy)', durationMinutes: 100, price: 110, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  ...
  { id: 'programa-glow-skin', category: 'Programas Faciales', categoryEn: 'Facial Programs', name: 'Programa Glow Skin', nameEn: 'Glow Skin Program', durationMinutes: 100, price: 310, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  { id: 'programa-anti-aging', category: 'Programas Faciales', categoryEn: 'Facial Programs', name: 'Programa Anti-Aging', nameEn: 'Anti-Aging Program', durationMinutes: 100, price: 430, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  ...
  { id: 'drenaje-linfatico-50', category: 'Masajes & Rituales Essentia', categoryEn: 'Massages & Essentia Rituals', name: 'Drenaje linfático avanzado Essentia · 50 min', nameEn: 'Essentia advanced lymphatic drainage · 50 min', durationMinutes: 50, price: 100, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  ...
  { id: 'micropigmentacion-cejas-retoque', category: 'Micropigmentación', categoryEn: 'Microblading', name: 'Micropigmentación cejas + retoque', nameEn: 'Eyebrow microblading + touch-up', durationMinutes: 210, price: 260, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
];
