...
module.exports = [
  ...
  { id: 'brows-basic', category: 'Hilo & Lifting', categoryEn: 'Threading & Lifting', name: 'Mirada Serena (hilo + lifting coreano)', nameEn: 'Brows Basic (thread eyebrows + Korean lifting)', durationMinutes: 60, price: 45, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  { id: 'brows-glam', category: 'Hilo & Lifting', categoryEn: 'Threading & Lifting', name: 'Mirada Dorada (hilo + henna + lifting coreano)', nameEn: 'Brows Glam (thread eyebrows + henna + Korean lifting)', durationMinutes: 60, price: 60, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  { id: 'brows-signature', category: 'Hilo & Lifting', categoryEn: 'Threading & Lifting', name: 'Mirada Sublime (hilo + lifting trad. + laminado + tinte)', nameEn: 'Brows Signature (thread + traditional lifting + lamination + tint)', durationMinutes: 60, price: 75, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
