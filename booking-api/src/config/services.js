...
module.exports = [
  ...
  { id: 'hilo-cejas-labio-menton', category: 'Hilo & Lifting', categoryEn: 'Threading & Lifting', name: 'Cejas + Labio + Mentón (hilo)', nameEn: 'Eyebrows + Lip + Chin (thread)', durationMinutes: 50, price: 22, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
