...
module.exports = [
  ...
  { id: 'laser-cuerpo-completo', category: 'Depilación Láser SHR', categoryEn: 'SHR Laser Hair Removal', name: 'Cuerpo completo', nameEn: 'Full body', durationMinutes: 60, price: 210, paymentPolicy: 'deposit_required', depositPercent: 30 },
  ...
  { id: 'brows-basic', category: 'Hilo & Lifting', categoryEn: 'Threading & Lifting', name: 'Brows Basic (hilo cejas + lifting coreano)', nameEn: 'Brows Basic (thread eyebrows + Korean lifting)', durationMinutes: 60, price: 45, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  { id: 'brows-glam', category: 'Hilo & Lifting', categoryEn: 'Threading & Lifting', name: 'Brows Glam (hilo cejas + henna + lifting coreano)', nameEn: 'Brows Glam (thread eyebrows + henna + Korean lifting)', durationMinutes: 60, price: 60, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  { id: 'brows-signature', category: 'Hilo & Lifting', categoryEn: 'Threading & Lifting', name: 'Brows Signature (hilo + lifting trad. + laminado + tinte)', nameEn: 'Brows Signature (thread + traditional lifting + lamination + tint)', durationMinutes: 60, price: 75, paymentPolicy: 'deposit_required', depositPercent: 30 },
  ...
  { id: 'dermapen', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Dermapen', nameEn: 'Dermapen', durationMinutes: 60, price: 75, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'mesoterapia-virtual', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Mesoterapia virtual', nameEn: 'Virtual mesotherapy', durationMinutes: 60, price: 85, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'fotorejuvenecimiento-ipl', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Fotorejuvenecimiento (IPL)', nameEn: 'Photorejuvenation (IPL)', durationMinutes: 60, price: 100, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'exosomas-dermapen', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Exosomas + PDRN con Dermapen PRO', nameEn: 'Exosomes + PDRN with Dermapen PRO', durationMinutes: 60, price: 140, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'ritual-basic-skin', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Ritual Basic Skin (limpieza + dermaplaning)', nameEn: 'Ritual Basic Skin (cleansing + dermaplaning)', durationMinutes: 90, price: 75, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'ritual-relaxing', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Ritual Hidra-Relax (dermaplaning + hidratación + masaje)', nameEn: 'Ritual Hidra-Relax (dermaplaning + hydration + massage)', durationMinutes: 90, price: 80, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'ritual-flash-lifting', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Ritual Flash Lifting (limpieza + radiofrecuencia + maderoterapia)', nameEn: 'Ritual Flash Lifting (cleansing + radiofrequency + wood therapy)', durationMinutes: 100, price: 110, paymentPolicy: 'deposit_required', depositPercent: 30 },

  // ── 04 · PROGRAMAS FACIALES ── (todos 1h40 min, según indicaste)
  { id: 'programa-periocular', category: 'Programas Faciales', categoryEn: 'Facial Programs', name: 'Programa Periocular', nameEn: 'Periocular Program', durationMinutes: 100, price: 250, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'programa-glow-skin', category: 'Programas Faciales', categoryEn: 'Facial Programs', name: 'Programa Glow Skin', nameEn: 'Glow Skin Program', durationMinutes: 100, price: 310, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'programa-anti-aging', category: 'Programas Faciales', categoryEn: 'Facial Programs', name: 'Programa Anti-Aging', nameEn: 'Anti-Aging Program', durationMinutes: 100, price: 430, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'programa-control-acne', category: 'Programas Faciales', categoryEn: 'Facial Programs', name: 'Programa Control Acné', nameEn: 'Acne Control Program', durationMinutes: 100, price: 460, paymentPolicy: 'deposit_required', depositPercent: 30 },
  ...
  { id: 'fotorejuvenecimiento-corporal', category: 'Corporales', categoryEn: 'Body Treatments', name: 'Fotorejuvenecimiento corporal', nameEn: 'Body photorejuvenation', durationMinutes: 45, price: 150, paymentPolicy: 'deposit_required', depositPercent: 30 }, // [ESTIMADO] duración
  ...
  { id: 'kobido-lifting-facial', category: 'Masajes & Rituales Essentia', categoryEn: 'Massages & Essentia Rituals', name: 'Kobido o lifting facial · 45 min', nameEn: 'Kobido or facial lifting massage · 45 min', durationMinutes: 55, price: 80, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  ...
  { id: 'drenaje-linfatico-50', category: 'Masajes & Rituales Essentia', categoryEn: 'Massages & Essentia Rituals', name: 'Drenaje linfático avanzado Essentia · 50 min', nameEn: 'Essentia advanced lymphatic drainage · 50 min', durationMinutes: 50, price: 100, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'masaje-prenatal-50', category: 'Masajes & Rituales Essentia', categoryEn: 'Massages & Essentia Rituals', name: 'Masaje prenatal Essentia · 50 min', nameEn: 'Essentia prenatal massage · 50 min', durationMinutes: 50, price: 110, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'ritual-reparador-solar-70', category: 'Masajes & Rituales Essentia', categoryEn: 'Massages & Essentia Rituals', name: 'Ritual reparador solar · 70 min', nameEn: 'Solar recovery ritual · 70 min', durationMinutes: 70, price: 120, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'ritual-essentia-80', category: 'Masajes & Rituales Essentia', categoryEn: 'Massages & Essentia Rituals', name: 'Ritual Essentia · 80 min', nameEn: 'Essentia ritual · 80 min', durationMinutes: 80, price: 160, paymentPolicy: 'deposit_required', depositPercent: 30 },
  ...
  { id: 'tatuaje-talla-l', category: 'Eliminación de tatuajes', categoryEn: 'Tattoo Removal', name: 'Talla L · hasta 15×15 cm', nameEn: 'Size L · up to 15×15 cm', durationMinutes: 30, price: 120, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'tatuaje-talla-xl', category: 'Eliminación de tatuajes', categoryEn: 'Tattoo Removal', name: 'Talla XL · más de 15×15 cm', nameEn: 'Size XL · over 15×15 cm', durationMinutes: 60, price: 170, paymentPolicy: 'deposit_required', depositPercent: 30 },
  ...
  { id: 'retoque-micropigmentacion', category: 'Micropigmentación', categoryEn: 'Microblading', name: 'Retoque micropigmentación anual', nameEn: 'Annual microblading touch-up', durationMinutes: 120, price: 100, paymentPolicy: 'deposit_required', depositPercent: 30 },
  { id: 'micropigmentacion-cejas-retoque', category: 'Micropigmentación', categoryEn: 'Microblading', name: 'Micropigmentación cejas + retoque', nameEn: 'Eyebrow microblading + touch-up', durationMinutes: 210, price: 260, paymentPolicy: 'deposit_required', depositPercent: 30 },
];
