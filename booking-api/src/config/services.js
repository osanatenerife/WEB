...
module.exports = [
  ...
  { id: 'hilo-cejas-labio-menton', category: 'Hilo & Lifting', categoryEn: 'Threading & Lifting', name: 'Cejas Esenciales (hilo: cejas + labio + mentón)', nameEn: 'Brows Essentials (thread: eyebrows + lip + chin)', durationMinutes: 50, price: 22, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
  ...
  { id: 'limpieza-facial-premium', category: 'Faciales & Aparatología', categoryEn: 'Facials & Devices', name: 'Limpieza facial premium (Limpieza facial profunda + Hollywood Peel)', nameEn: 'Premium facial cleansing (Deep facial cleansing + Hollywood Peel)', durationMinutes: 90, price: 95, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
