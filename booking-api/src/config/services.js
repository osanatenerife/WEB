...
module.exports = [
  ...
  { id: 'brows-signature', category: 'Hilo & Lifting', categoryEn: 'Threading & Lifting', name: 'Cejas Perfectas (hilo + lifting trad. + laminado + tinte)', nameEn: 'Brows Signature (thread + traditional lifting + lamination + tint)', durationMinutes: 60, price: 75, paymentPolicy: 'deposit_or_full', depositPercent: 30 },
