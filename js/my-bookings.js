...
(function () {
  ...
  const STR = {
    ...
    noShowForgivenNote: { es: 'Falta perdonada (1ª vez), sin coste. Próxima vez: avisa con 48h.', en: 'Forgiven (1st time), no charge. Next time: give 48h notice.' },
    noShowForgivenBonoNote: { es: 'Falta perdonada — sesión disponible arriba. Avisa con 48h.', en: 'Forgiven — session available above. Give 48h notice.' },
    noShowPenalizedBonoNote: { es: 'Falta — sesión del bono descontada. Avisa con 48h.', en: 'No-show — package session deducted. Give 48h notice.' },
    noShowPenalizedNote: { es: 'Falta — importe de la reserva descontado. Avisa con 48h.', en: 'No-show — booking fee deducted. Give 48h notice.' },
